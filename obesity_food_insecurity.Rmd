...
# legend colours I want. Then I saved it as a file using anim_save. Although
# there is an error that says I do not specify an animation object to save,
# I used plot = last_animation(), which does indicate the animation object.
