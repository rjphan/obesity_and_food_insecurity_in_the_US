...
rural_income <- read_csv("raw_data/Rural Atlas Data/Income.csv")

# Read in income data for all US Counties from
# https://www.ers.usda.gov/data-products/county-level-data-sets/download-data/
# (US Bureau of Labour Statistics). Might not use it.

income <- read_excel("raw_data/Unemployment.xls", skip = 4)
...
cpi <- read_excel("raw_data/historicalcpi.xlsx", skip = 1)
